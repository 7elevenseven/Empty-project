 ...
 *
 * This file contains the basic class and methodes for compiling Smarty template with lexer/parser
 *
 * @package Smarty
 * @subpackage Compiler
 * @author Uwe Tews
...
abstract class Smarty_Internal_TemplateCompilerBase
{
    ...
    /**
     * uid of template called by {extends} for recursion check
     *
     * @var array
     */
    ...
    public function compileTemplate(Smarty_Internal_Template $template, $nocache = false)
    {
        ...
        if (empty($this->template->source->components)) {
            ...
            // we have array of inheritance template by extends: resource
    ...
    public function compileTag($tag, $args, $parameter = array())
    {
        ...
        // compile the smarty tag (required compile class to compile the tag are autoloaded)
