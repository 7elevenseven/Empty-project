 ...
 *
 * This file contains the basic class and methodes for template and variable creation
 *
 * @package Smarty
 * @subpackage Template
 * @author Uwe Tews
...
{
    /**
     * name of class used for template
     *
     * @var string
     */
     ...
     * @param  boolean $search_parents include parent template?
