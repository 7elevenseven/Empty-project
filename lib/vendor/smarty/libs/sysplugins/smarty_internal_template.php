...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
     ...
     *
     * It does compare the timestamps of template source and the compiled template and checks the force compile configuration
     *
    ...
    /**
     * Create code frame for compiled and cached template
     *
