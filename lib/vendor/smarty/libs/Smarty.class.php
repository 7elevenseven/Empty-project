...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * modes for handling of "<?php ... ?>" tags in template.
     */
    ...
    /**
     * merge compiled include
     * @var boolean
     */
    public $merge_compiled_includes = false;
    /**
     * template inheritance merge compiled include
     * @var boolean
     */    
    ...
    /**
     * Should compiled-template be prevented from being called directly?
     *
     * {@internal
    ...
    /**
     * Saved parameter of merged template during compilation
     *
     * @var array
     */
     ...
     *
     * @param  string $compile_dir directory to store compiled template in
     * @return Smarty current Smarty instance for chaining
     */
     ...
     * Set cache directory
     *
     * @param  string $cache_dir directory to store cached template in
     * @return Smarty current Smarty instance for chaining
     */
    ...
    /**
     * Takes unknown class and loads plugin files for them
